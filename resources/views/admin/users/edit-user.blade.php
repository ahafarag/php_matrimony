                ...
                <div class="card card-primary">
                    <div class="card-body">
                        ...
                        <ul class="list-group">
                            ...
                            <li class="list-group-item d-flex justify-content-between align-items-center">@lang('Account Status')
                                <span
                                    class="badge badge-{{($user->status==1) ? 'success' :'danger'}} success badge-pill">{{($user->status==1) ? trans('Active') : trans('Inactive')}}</span>
                            </li>
                            <li class="list-group-item d-flex justify-content-between align-items-center">@lang('Profile Status')
                                <span class="badge badge-pill {{ optional($user->profileInfo)->status == 0 ? 'badge-danger' : 'badge-success' }}">
                                    {{ optional($user->profileInfo)->status == 0 ? 'Pending' : 'Approved' }}
                                </span>
                            </li>
                        </ul>
                    </div>
                ...
                <div class="card card-primary">
                    <div class="card-body">
                        ...
                        <div class="btn-list ">
                            ...
                            @if(adminAccessRoute(config('role.user_management.access.edit')))
                                <a class="loginAccount btn btn-info btn-sm text-white cursor-pointer"
                                    data-toggle="modal"
                                    data-target="#signIn"
