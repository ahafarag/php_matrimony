        ...
        <div class="card-body">
            @if(adminAccessRoute(config('role.user_management.access.add')))
                <div class="media mb-4 float-right">
                    <a href="{{route('admin.politicalViewCreate')}}" class="btn btn-sm btn-primary mr-2">
                        ...
                        <tr>
                            ...
                            <td data-label="@lang('Action')">
                                @if(adminAccessRoute(config('role.user_management.access.add')))
                                        ...
                                        <a href="{{ route('admin.politicalViewEdit',$item->id) }}" class="btn btn-sm btn-primary edit-button">
                                ...
                                @if(adminAccessRoute(config('role.user_management.access.delete')))
                                    ...
                                    <a href="javascript:void(0)"
                                       data-route="{{ route('admin.politicalViewDelete', $item->id) }}"
                                       data-toggle="modal"
