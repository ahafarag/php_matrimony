            ...
            <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
                ...
                <div class="card-body">
                    <div class="row align-items-center justify-content-between mb-3">
                        ...
                        <div class="col-md-6">
                            <a href="https://www.youtube.com/watch?v=MQszEDuWFeQ" target="_blank" class="btn btn-primary btn-sm mb-2  float-right" type="button">
                    ...
                    <p>
                        ...
                        <a href="https://dashboard.pusher.com/accounts/sign_up" target="_blank">
                            @lang('Create an account') <i class="fas fa-external-link-alt"></i>
                        </a>
