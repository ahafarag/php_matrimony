...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <div class="mt-2">
                <form method="post" action="{{ route('admin.casteUpdate',[$id]) }}" class="mt-4">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-sm-12 col-md-12 mb-4">
                            ...
                            <select name="religion_id" class="form-control @error('religion_id') is-invalid @enderror">
                                @forelse ($religionList as $item)
                                    <option value="{{ $item->id }}" {{ $item->id == $casteList[0]->religion_id ? 'selected' : '' }}>@lang($item->name)</option>
                                @empty
                                @endforelse
                            </select>
                        ...
                        <div class="col-sm-12 col-md-12 mb-3">
                            ...
                            <input type="text" name="name"
                                   ...
                                   value="<?php echo old('name', isset($casteList) ? @$casteList[0]->name : '') ?>">
