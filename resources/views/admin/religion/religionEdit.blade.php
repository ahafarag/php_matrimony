...
@section('content')
    ...
    <div class="card card-primary m-0 m-md-4 my-4 m-md-0 shadow">
        <div class="card-body">
            ...
            <div class="mt-2">
                <form method="post" action="{{ route('admin.religionUpdate',[$id]) }}" class="mt-4" enctype="multipart/form-data">
                    @csrf
                    @method('put')
                    <div class="row">
                        <div class="col-sm-12 col-md-12 mb-3">
                            ...
                            <input type="text" name="name"
                                   ...
                                   value="<?php echo old('name', isset($religionList) ? @$religionList[0]->name : '') ?>">
