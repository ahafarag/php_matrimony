                            ...
                            <div class="row generate-btn-parent">
                                <div class="col-sm-12 col-md-6">
                                    ...
                                    <input type="text" name="name[{{ $language->id }}]"
                                            ...
                                            value="<?php echo old('name'.$language->id, isset($planDetails[$language->id]) ? @$planDetails[$language->id][0]->name : '') ?>" placeholder="@lang('Enter package name')">
                                ...
                                @if ($loop->index == 0)
                                    <div class="col-sm-12 col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="<?php echo old('price'.$language->id, isset($planDetails[$language->id]) ? @$planDetails[$language->id][0]->plan->price : '') ?>" placeholder="@lang('Enter package price')">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <input type="text" name="icon"
                                                       ...
                                                       value="<?php echo old('icon'.$language->id, isset($planDetails[$language->id]) ? @$planDetails[$language->id][0]->plan->icon : '') ?>"
                                                       placeholder="@lang('Select Icon')">
                                                <div class="input-group-append">
                                                    <button class="btn btn-outline-primary iconPicker"
                                                    data-icon="{{ old('icon'.$language->id, isset($planDetails[$language->id]) ? @$planDetails[$language->id][0]->plan->icon : '') }}"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-switch-btn">
                                                ...
                                                <input type="checkbox" name="show_auto_profile_match" class="custom-switch-checkbox"
                                                    ...
                                                    value="0" {{($planDetails[$language->id][0]->plan->show_auto_profile_match == 0) ? 'checked' : ''}}>
                                    ...
                                    <div class="col-sm-12 col-md-6 mb-3">
                                        ...
                                        <input type="number" name="express_interest" class="form-control"
                                        value="<?php echo old('express_interest'.$language->id, isset($planDetails[$language->id]) ? @$planDetails[$language->id][0]->plan->express_interest : '') ?>" placeholder="@lang('Enter express interest number')">
                                    ...
                                    <div class="col-sm-6 col-md-4 col-lg-3 mb-3">
                                        ...
                                        <div class="custom-switch-btn">
                                            ...
                                            <input type="checkbox" name="express_interest_status" class="custom-switch-checkbox"
                                                ...
                                                value="0" {{($planDetails[$language->id][0]->plan->express_interest_status == 0) ? 'checked' : ''}}>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="number" name="gallery_photo_upload" class="form-control"
                                        value="<?php echo old('gallery_photo_upload'.$language->id, isset($planDetails[$language->id]) ? @$planDetails[$language->id][0]->plan->gallery_photo_upload : '') ?>" placeholder="@lang('Enter gallery photo upload number')">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-switch-btn">
                                                ...
                                                <input type="checkbox" name="gallery_photo_upload_status" class="custom-switch-checkbox"
                                                    ...
                                                    value="0" {{($planDetails[$language->id][0]->plan->gallery_photo_upload_status == 0) ? 'checked' : ''}}>
                                    ...
                                    <div class="col-sm-12 col-md-6">
                                        ...
                                        <input type="number" name="contact_view_info" class="form-control"
                                        value="<?php echo old('contact_view_info'.$language->id, isset($planDetails[$language->id]) ? @$planDetails[$language->id][0]->plan->contact_view_info : '') ?>" placeholder="@lang('Enter profile info view number')">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="custom-switch-btn">
                                                ...
                                                <input type="checkbox" name="contact_view_info_status" class="custom-switch-checkbox"
                                                    ...
                                                    value="0" {{($planDetails[$language->id][0]->plan->contact_view_info_status == 0) ? 'checked' : ''}}>
                                    ...
                                    <div class="col-sm-6 col-md-6 col-lg-4 mt-4 mb-2">
                                        ...
                                        <div class="custom-switch-btn">
                                            ...
                                            <input type="checkbox" name="status" class="custom-switch-checkbox"
                                                id="status"
                                                value="0" {{($planDetails[$language->id][0]->plan->status == 0) ? 'checked' : ''}}>
