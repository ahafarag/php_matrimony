                            ...
                            <div class="row">
                                <div class="col-sm-12 col-md-12 my-3">
                                    <div class="form-group ">
                                        ...
                                        <textarea class="form-control summernote @error('details'.'.'.$language->id) is-invalid @enderror" name="details[{{ $language->id }}]" id="summernote" rows="15" value="<?php echo old('author'.$language->id, isset($blogDetails[$language->id]) ? @$blogDetails[$language->id][0]->details : '') ?>"><?php echo old('author'.$language->id, isset($blogDetails[$language->id]) ? @$blogDetails[$language->id][0]->details : '') ?></textarea>
