        ...
        <div class="card-body">
            @if(adminAccessRoute(config('role.user_management.access.add')))
                <div class="media mb-4 float-right">
                    <a href="{{route('admin.communityValueCreate')}}" class="btn btn-sm btn-primary mr-2">
            ...
            <div class="table-responsive">
                <table class="categories-show-table table table-hover table-striped table-bordered" id="zero_config">
                    ...
                    <tbody>
                    @forelse($communityValue as $item)
                        <tr>
                            ...
                            <td data-label="@lang('Action')">
                                @if(adminAccessRoute(config('role.user_management.access.add')))
                                        ...
                                        <a href="{{ route('admin.communityValueEdit',$item->id) }}" class="btn btn-sm btn-primary edit-button">
                                ...
                                @if(adminAccessRoute(config('role.user_management.access.delete')))
                                    ...
                                    <a href="javascript:void(0)"
                                       data-route="{{ route('admin.communityValueDelete', $item->id) }}"
                                       data-toggle="modal"
