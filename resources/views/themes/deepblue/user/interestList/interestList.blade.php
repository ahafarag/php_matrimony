...
@section('title',__('My Interest List'))
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="dashboard-title">
                                    <h5>@lang('My Interest List')</h5>
                                </div>

                                <div class="row">
                                    <div class="col-12 mb-3">
                                        <div class="search-area table-search">
                                            <form action="{{ route('user.interest.search') }}" method="get">
                                                @csrf
                                                <div class="row g-3">
                                    ...
                                    <div class="col">
                                        <div class="table-wrapper table-responsive">
                                            <table class="table table-striped">
                                                ...
                                                <tbody>
                                                @forelse($interestList as $key => $value)
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="javascript:void(0)"
                                                               data-route="{{ route('user.interest.delete',$value->id) }}"
                                                               data-bs-toggle="modal"
        ...
        <div class="modal-dialog">
            <div class="modal-content form-block">
                <div class="modal-header">
                    <h5 class="modal-title">@lang('Remove From Interest Confirmation')</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>@lang('Are Your Sure To Remove This Member From Your Interest List?')</p>
                </div>
