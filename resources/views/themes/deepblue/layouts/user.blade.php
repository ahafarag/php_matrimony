...
<head>
    ...
    <link rel="stylesheet" href="{{asset($themeTrue.'css/jquery-ui.min.css')}}"/>
                ...
                <div class="notification-panel pe-3">
                    ...
                    <ul class="notification-dropdown userprofile">
                        <div class="dropdown-box">
                            ...
                            <li>
                                <a class="dropdown-item align-items-center px-3"
                    ...
                    <div class="row g-4">
                        <div class="col-lg-2">
                            <input type="number" name="age_from" id="age_from"
                                   value="{{old('age_from',request()->age_from)}}" class="form-control" min="1" step="1"
                                   placeholder="@lang('age from')"/>
                            @error('age_from')
                            <span class="text-danger">@lang($message)</span>
                            @enderror
                        </div>
                        <div class="col-lg-2">
                            <input type="number" name="age_to" id="age_to" value="{{old('age_to',request()->age_to)}}"
                                   class="form-control" min="1" step="1" placeholder="@lang('age to')"/>
                            @error('age_to')
                            <span class="text-danger">@lang($message)</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-lg-2">
                            <select name="religion" class="form-select" aria-label="religion">
                                ...
                                @foreach ($religion as $data)
                                    <option
                                        value="{{$data->id}}" {{old('religion',request()->religion) == $data->id ? 'selected' : ''}}>{{$data->name}}</option>
                                @endforeach
                            </select>
                            @error('religion')
                            <span class="text-danger">@lang($message)</span>
                        ...
                        <div class="col-lg-2">
                            <select name="marital_status" id="marital_status" class="form-select"
                                ...
                                @foreach($maritalStatus as $data)
                                    <option
                                        value="{{$data->marital_status_id}}" {{ old('marital_status', request()->marital_status) == $data->marital_status_id ? 'selected' : ''  }}>@lang($data->name)</option>
                                @endforeach
                            </select>
                        ...
                        <div class="col-lg-2">
                            <select class="form-select" name="gender" id="gender" aria-label="gender">
                                ...
                                <option
                                    value="Male" {{ old('gender', request()->gender) == 'Male' ? 'selected' : ''}}>@lang('Male')</option>
                                <option
                                    value="Female" {{ old('gender', request()->gender) == 'Female' ? 'selected' : ''}}>@lang('Female')</option>
                            </select>
                            @error('gender')
                            <span class="text-danger">@lang($message)</span>
                            @enderror
